...
// -- Project -------------------------------------
#define PROJECT                "sonoff1"          // PROJECT is used as the default topic delimiter and OTA file name
...
#define STA_SSID1              "Bogert-2G"      // [Ssid1] Wifi SSID
#define STA_PASS1              "gotoronto"  // [Password1] Wifi password
